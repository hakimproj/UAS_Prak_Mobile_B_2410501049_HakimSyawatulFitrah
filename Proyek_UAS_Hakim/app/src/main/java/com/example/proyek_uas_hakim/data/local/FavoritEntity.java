...
public class FavoritEntity {
    ...
    public FavoritEntity(@NonNull String id, String tipe, String nama, String namaLatin,
                         String deskripsi, String asal, String sebaran, String foto,
                         String sumberFoto, String video, String sumberVideo, String status) {
        this.id = id;
        this.tipe = tipe;
        this.nama = nama;
